function [ net, Contengency_train, Contengency_test, Aux_train, Aux_test,test_results,test_train1b1] = UseNN( trainD,testD,train_lbl,test_lbl,net,trainFCN, Aux_train,Aux_test )
...
%    Final result for Training
 ...
 Final_Results_test = []; 
    ...
    test_results=Final_Results_test;
