...
A = csvread('Chile.csv',2,1);  
%'Chile,nM=50,dtp=15.xlsx');  %('Hindukush,nM=50,dtp=15.xls'); %(   
...
%                                   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  clearvars -except Actual_Mag Threshold trainD testD ind test_lbl train_lbl randomorder train_actual_lbl test_actual_lbl 
%   
  %%%%% ------------Feature selection
     %%%% relevance filter
     L = size(trainD,1);
     ...
     clearvars -except Threshold Actual_Mag trainD testD ind test_lbl train_lbl featSet1 featSet2 MI randomorder aaa bbb RC randomorder train_actual_lbl test_actual_lbl 
  %%% ------------- SVR
...
%    disp(SVR_train_binary)
%    disp(SVR_test_binary)
%   
  ...
  trainFCN = 'trainlm';
  [ net, Contengency_train1, Contengency_test1, Aux_trainNN, Aux_testNN,test_results,test_trainlb ] = UseNN( trainD,testD,train_lbl,test_lbl,net,trainFCN,Aux_train,Aux_test );
 ...
 %%% ------------- fourth   NN -------------------
  ...
  trainFCN = 'trainbr';
  [ net, Contengency_train4, Contengency_test4, Aux_trainNN, Aux_testNN ] = UseNN( trainD,testD,train_lbl,test_lbl,net,trainFCN,Aux_train,Aux_test );

  %%%------------ Fourth  EPSO
 [ net, Contengency_trainEPSO4, Contengency_testEPSO4, Aux_train, Aux_test ] = UseEPSO( trainD,testD,train_lbl,test_lbl, net, Aux_train,Aux_test );
